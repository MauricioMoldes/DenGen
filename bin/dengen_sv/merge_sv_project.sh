...
do
  ...
  for tool in ${tools[@]}; do
     echo "$line"| sed "s|^|/ngc/projects2/gm/people/mauqua/dengen/data/sv/|g" | sed "s|$|_cnv_germline_raw."$tool".vcf|g" >> /ngc/projects2/gm/people/mauqua/dengen/bin/"$tool"_temporary_file 
