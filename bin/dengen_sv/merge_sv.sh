...
SURVIVOR merge /ngc/projects2/gm/people/mauqua/dengen/bin/temporary_file 1000 2 1 0 0 50 /ngc/projects2/gm/people/mauqua/dengen/results/dengen_sv_merged/"$line".vcf
